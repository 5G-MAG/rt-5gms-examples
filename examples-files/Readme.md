...
## `ContentHostingConfiguration_Example_pull-ingest.json`

This file is used as a content hosting configuration for the rt-5gms-application-function.

It contains a ContentHostingConfiguration, based on 3GPP TS 26.512 Release 17.4.0, which points to a media origin host, suitable for use with pull-ingest, which holds content in both HLS and DASH media streaming formats.
...
## `PolicyTemplate_Example.json`

This file contains a Policy Template example.

## `ConsumptionReportingConfiguration_Example.json`

This file contains a Consumptin Reporting Configuration example.

## `MetricsReportingConfiguration_Example.json`

This file contains a Metrics Reporting Configuration example.
